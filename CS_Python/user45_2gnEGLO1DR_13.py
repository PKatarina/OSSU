...
class Ship:
    ...
    def draw(self,canvas):
        if self.thrust:
            ...
            canvas.draw_image(self.image, [135,45], self.image_size, self.pos, [self.radius*2,2*self.radius],self.angle)
        else:    
...
def draw(canvas):
    ...
    canvas.draw_text("Score "+str(score),[WIDTH*0.2,HEIGHT/12],30,"rgba(114,50,200,0.3)")
    canvas.draw_text("Lives "+str(lives),[WIDTH*0.7,HEIGHT/12],30,"rgba(200,50,150,0.4)")
